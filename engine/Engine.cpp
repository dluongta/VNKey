...
static list<vector<Uint32>> _typingStates; //typing helper, save long state of Typing word, can go back and modify the word
...
static int _spaceCount = 0; 
static bool _hasHandledMacro = false;
